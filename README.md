# TripSit TripBot Dashboard

This dashboard helps navigate TripSit's bot, TripBot, and its features.

## Features

Right now the dashboard is in its infancy, but it has a few features:
* Invite the bot
* Ban Appeals
* Info on help needed
