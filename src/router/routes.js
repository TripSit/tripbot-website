...
const BanAppeal = () => import('@/pages/BanAppeal');
const Logs = () => import('@/pages/Logs');
const Settings = () => import('@/pages/Settings');
const Setup = () => import('@/pages/Setup');
const NotFound = () => import('@/pages/NotFound');
const HelpWanted = () => import('@/pages/HelpWanted');
...
export default [
    { path: '/', name: 'Homepage', component: Landing },
    {
        ...
        children: [
            ...
            { path: 'appeals', name: 'BanAppeal', component: BanAppeal },
            { path: 'volunteer', name: 'Volunteer', component: HelpWanted},
